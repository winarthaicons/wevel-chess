...
/// engine_info() returns the full name of the current Wevel version. This
/// will be either "Wevel <Tag> DD-MM-YY" (where DD-MM-YY is the date when
/// the program was compiled) or "Wevel <Version>", depending on whether
/// Version is empty.
